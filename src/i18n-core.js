...
// ── 2026-08-08 未翻译清单：中频词条（裸引号统一翻译） ──
    ...
    ["\"opened this PR\"", "\"已打开此 PR\""],
    ["\"View diff on GitHub\"", "\"在 GitHub 上查看差异\""],
    ["\"Don't revert\"", "\"不要还原\""],
    ["\"pull request\"", "\"拉取请求\""],
    ["\"Export Chat (Developer)\"", "\"导出聊天（开发者）\""],
    ["\"Dedicated Agent Runtime\"", "\"专用智能体运行时\""],
    ["\"Continue interrupted agents on relaunch\"", "\"重新启动时继续被中断的智能体\""],
    ["\"Agents UI\"", "\"智能体界面\""],
    ["\"Automatically open project threads in split view\"", "\"在分屏视图中自动打开项目线程\""],
    ["\"Wake Project when threads finish\"", "\"线程完成时唤醒项目\""],
    ["\"Show full list of sidebar sections\"", "\"显示侧边栏分区的完整列表\""],
    ["\"Highlight open sections\"", "\"高亮打开的分区\""],
    ["\"Persistent sidebar\"", "\"固定侧边栏\""],
    ["\"Collapse sidebar to icon rail when opening a tab\"", "\"打开标签时折叠侧边栏为图标栏\""],
    ["\"Share open sections across agents\"", "\"在智能体间共享打开的分区\""],
    ["\"Default Environment\"", "\"默认环境\""],
    ["\"Verify Extension Signatures\"", "\"验证扩展签名\""],
    ["\"Always Applied\"", "\"始终应用\""],
    ["\"Give the Agent a Confetti Cannon\"", "\"给智能体一个彩纸炮\""],
    ["\"Allow Agents on My PRs\"", "\"允许智能体处理我的 PR\""],
    ["\"Start When I Open a PR\"", "\"打开 PR 时启动\""],
    ["\"Post to Slack\"", "\"发布到 Slack\""],
    ["\"Merge status pending\"", "\"合并状态待定\""],
    ["\"Cannot be merged\"", "\"无法合并\""],
    ["\"Disabled (Reload Required)\"", "\"已禁用（需要重载）\""],
    ["\"Retry cloud agent request\"", "\"重试云智能体请求\""],
    ["\"Link Privacy\"", "\"链接隐私\""],
    ["\"initial result\"", "\"初始结果\""],
    ["\"My Task\"", "\"我的任务\""],
    ...
    ["\"Replace all in file\"", "\"替换文件中的所有内容\""],
    ["\"Cloud Agent\"", "\"云智能体\""],
    ["\"Cannot Reject This Suggestion\"", "\"无法拒绝此建议\""],
    ["\"Cannot Move To Local\"", "\"无法移至本地\""],
    ["\"Chat history\"", "\"对话历史\""],
    ["\"Failed to enqueue follow-up\"", "\"加入后续队列失败\""],
    ...
    ["\"Connect repo\"", "\"连接仓库\""],
    ["\"Already added\"", "\"已添加\""],
    ["\"Plugin Tray Primary Action\"", "\"插件托盘主操作\""],
    ["\"Plugin Tray Cancel\"", "\"插件托盘取消\""],
    ["\"Split Tile Horizontally\"", "\"水平拆分平铺窗格\""],
    ["\"Split Tile Vertically\"", "\"垂直拆分平铺窗格\""],
    ["\"Remove from Tileset\"", "\"从平铺集中移除\""],
    ["\"Download Update\"", "\"下载更新\""],
    ["\"Help Improve Cursor\"", "\"帮助改进 Cursor\""],
    ["\"Search runs...\"", "\"搜索运行…\""],
    ["\"Enter your API key\"", "\"输入你的 API 密钥\""],
    ["\"Fix CI, conflicts, and comments with full self driving\"", "\"以完全自主的方式修复 CI、冲突和评论\""],
    ["\"Previous image\"", "\"上一张图片\""],
    ["\"Next image\"", "\"下一张图片\""],
    ["\"Fork this chat\"", "\"复制此对话\""],
    ["\"Claim your public profile\"", "\"认领你的公开个人资料\""],
    ["\"Run all commands without approval or sandboxing\"", "\"无需审批或沙箱即可运行所有命令\""],
    ["\"Run this agent in a new SSH worktree\"", "\"在新的 SSH 工作树中运行此智能体\""],
    ["\"Run this agent in a new git worktree\"", "\"在新的 git 工作树中运行此智能体\""],
    ["\"RPC call failed\"", "\"RPC 调用失败\""],
    ["\"Failed to fetch usage data\"", "\"获取使用数据失败\""],
    ["\"Cannot resume\"", "\"无法恢复\""],
    ["\"Cloud agent submit failed\"", "\"云智能体提交失败\""],
    ["\"Finalizing migration...\"", "\"正在完成迁移…\""],
    ["\"No selection precursor\"", "\"没有选定的前置内容\""],
    ["\"Failed to update the goal.\"", "\"更新目标失败。\""],
    ["\"Starting up environment\"", "\"正在启动环境\""],
    ["\"Failed to pull cloud agent locally.\"", "\"将云智能体拉取到本地失败。\""],
    ...
    ["\"Copied remote URL to clipboard\"", "\"已将远程 URL 复制到剪贴板\""],
    ["\"Couldn't load this agent's changes.\"", "\"无法加载此智能体的更改。\""],
    ["\"The amount needs to be a valid number\"", "\"金额必须是有效数字\""],
    ["\"Couldn't continue in cloud. Try again.\"", "\"无法在云中继续。请重试。\""],
    ["\"Can't add a cloud agent to a local project\"", "\"无法将云智能体添加到本地项目\""],
    ["\"Loading notes...\"", "\"正在加载笔记…\""],
    ["\"Worktree not found\"", "\"找不到工作树\""],
    ["\"Opened pull request page\"", "\"已打开拉取请求页面\""],
    ["\"Failed to add in recent locations.\"", "\"添加到最近位置失败。\""],
    ["\"Could not create a Cloud Automation\"", "\"无法创建云自动化\""],
    ["\"Could not start task\"", "\"无法启动任务\""],
    ["\"Could not delete task\"", "\"无法删除任务\""],
    ["\"Failed to copy auth ID\"", "\"复制身份验证 ID 失败\""],
    ["\"Cannot resolve authority\"", "\"无法解析权限机构\""],
    ["\"No workspace folder found\"", "\"未找到工作区文件夹\""],
    ["\"Dockerfile not in remote\"", "\"远程没有 Dockerfile\""],
    ["\"Snapshot saved.\"", "\"快照已保存。\""],
    ["\"Restore edits to the latest checkpoint\"", "\"将编辑恢复至最新检查点\""],
    ["\"All team members can view\"", "\"所有团队成员都可以查看\""],
    ["\"Choose which theme to use\"", "\"选择要使用的主题\""],
    ["\"Semantic Highlight\"", "\"语义高亮\""],
    ["\"Main UI thread blocked\"", "\"主 UI 线程被阻止\""],
    ["\"Clear Terminal\"", "\"清除终端\""],
    ["\"Sent to Chat\"", "\"已发送到对话\""],
    ["\"Extension RPC\"", "\"扩展 RPC\""],
    ["\"Delete chats older than how many days?\"", "\"删除多少天以前的对话？\""],
    ["\"Interactive Editor\"", "\"交互式编辑器\""],
    ["\"Execute the Contents of the Input Box\"", "\"执行输入框中的内容\""],    // ── 2026-08-08 未翻译清单：中频补充（模板/多形式） ──
    ["\"Always Run Selected\"", "\"始终运行所选项\""],
    ["`Always run selected commands (", "`始终运行所选命令 ("],
    ["`Always run these commands (", "`始终运行这些命令 ("],
    ["children:\"reopened this PR\"", "children:\"重新打开了此 PR\""],
    ["tooltip:\"Fork this chat and submit the current prompt\"", "tooltip:\"复制此对话并提交当前提示词\""],
    ["\"Cloud Agents\"", "\"云智能体\""],
    ["\"New Cloud Agent\"", "\"新建云智能体\""],
    ...
    ['action:"Create PRs"', 'action:"创建 PRs"'],
    ['action:"Create PR"', 'action:"创建 PR"'],
    ['action:"Checkout Branch"', 'action:"切换分支"'],
    ['action:"Update Branch"', 'action:"更新分支"'],
    ['label:"Copy Link"', 'label:"复制链接"'],
    ['children:"Copy Link"', 'children:"复制链接"'],
    ['label:"Start New Chat"', 'label:"开始新聊天"'],
    ['label:"Open Agent"', 'label:"打开智能体"'],
    ['children:"Open Agent"', 'children:"打开智能体"'],
    ['?"Copied!":"Copy ID"', '?"已复制！":"复制 ID"'],
    ['label:"Copy ID"', 'label:"复制 ID"'],
    ['children:"Copy ID"', 'children:"复制 ID"'],
    ['error:"Connect GitHub"', 'error:"连接 GitHub"'],
    ['label:"Open as Editor",tooltip:"Open as Editor"', 'label:"在编辑器中打开",tooltip:"在编辑器中打开"'],
    ['label:"Clear override"', 'label:"清除覆盖"'],
    ['label:"Add to Home"', 'label:"添加到主页"'],
    ['label:"Continue Anyway"', 'label:"仍然继续"'],
    ['title:"Grant repository access"', 'title:"授予仓库访问权限"'],
    ['connectLabel:"Grant Access"', 'connectLabel:"授予访问权限"'],
    ...
    ['pillLabel:"Connect Your Repos"', 'pillLabel:"连接你的仓库"'],
    ['"Unknown error"', '"未知错误"'],
    // ── 2026-08-08 未翻译清单：中频词条（glass 存在的形式）──
    ['children:"Fix All"', 'children:"全部修复"'],
    ['children:"Review Again"', 'children:"再次审查"'],
    ['?"Review Again":"Find Issues"', '?"再次审查":"查找问题"'],
    ['children:"Open settings"', 'children:"打开设置"'],
    ['children:"Install Now"', 'children:"立即安装"'],
    ['tooltip:"Delete chat"', 'tooltip:"删除对话"'],
    ['label:"Delete chat"', 'label:"删除对话"'],
    ['label:"Close Chat",tooltip:"Close Chat"', 'label:"关闭对话",tooltip:"关闭对话"'],
    ['label:"Close Other Chats",tooltip:"Close Other Chats"', 'label:"关闭其他对话",tooltip:"关闭其他对话"'],
    ['"aria-label":"Go back"', '"aria-label":"返回"'],
    ['label:"Go back"', 'label:"返回"'],
    ['children:"Go back"', 'children:"返回"'],
    ['?"Resume":"Try again"', '?"继续":"再试一次"'],
    ['?"Sends without interrupting the agent":"Send now"', '?"不打断 Agent 即可发送":"立即发送"'],
    ['hintText:"Send now"', 'hintText:"立即发送"'],
    ['"aria-label":"Send now"', '"aria-label":"立即发送"'],
    ['label:"Copy Image"', 'label:"复制图片"'],
    ['label:"Download Image"', 'label:"下载图片"'],
    ['label:"Fix with Agent"', 'label:"用 Agent 修复"'],
    ['hintText:"Fix with Agent"', 'hintText:"用 Agent 修复"'],
    ['label:"Find with Agent"', 'label:"用 Agent 查找"'],
    ['children:"Find with Agent"', 'children:"用 Agent 查找"'],
    ['name:"Find with Agent"', 'name:"用 Agent 查找"'],
    ['title:"Fix in Agent"', 'title:"在 Agent 中修复"'],
    ['="Fix in Agent",', '="在 Agent 中修复",'],
    ['label:"Commit Changes"', 'label:"提交更改"'],
    ['children:"Copy URL"', 'children:"复制 URL"'],
    ['?"Copied!":"Copy URL"', '?"已复制！":"复制 URL"'],
    ['?"Copied PR URL":"Copy PR URL"', '?"已复制 PR URL":"复制 PR URL"'],
    ['children:"Copy File Path"', 'children:"复制文件路径"'],
    ['label:"Open in External Browser"', 'label:"在外部浏览器中打开"'],
    ['children:"Open in External Browser"', 'children:"在外部浏览器中打开"'],
    ['label:"Open in IDE"', 'label:"在 IDE 中打开"'],
    ['label:"Open as Pane",tooltip:"Open as Pane"', 'label:"在窗格中打开",tooltip:"在窗格中打开"'],
    ...
    ['?"Rebase merges":"Merge commits"', '?"变基合并":"合并提交"'],
    ['label:"Rebase merge",tooltip:"Rebase and merge commits"', 'label:"变基合并",tooltip:"变基并合并提交"'],
    ['label:"Merge manually"', 'label:"手动合并"'],
    ['label:"Default Mode"', 'label:"默认模式"'],
    ['"aria-label":"Default Mode"', '"aria-label":"默认模式"'],
    ['label:"Open in Design Mode"', 'label:"在设计模式下打开"'],
    ['title:"Design Mode"', 'title:"设计模式"'],
    ['label:"Design Mode"', 'label:"设计模式"'],
    ['label:"New Environment"', 'label:"新建环境"'],
    ['title:"New Environment"', 'title:"新建环境"'],
    ['children:"Manage Environments"', 'children:"管理环境"'],
    ['label:"Edit MCP configuration"', 'label:"编辑 MCP 配置"'],
    ['label:"Delete MCP server"', 'label:"删除 MCP 服务器"'],
    ['label:"Enable Action"', 'label:"启用操作"'],
    ['children:"Scroll to bottom"', 'children:"滚动到底部"'],
    ['title:"Scroll to bottom"', 'title:"滚动到底部"'],
    ['"aria-label":"Scroll to bottom"', '"aria-label":"滚动到底部"'],
    ['"aria-label":"New session"', '"aria-label":"新会话"'],
    ['title:"New session"', 'title:"新会话"'],
    ['children:"New session"', 'children:"新会话"'],
    ['title:"Confirm Action"', 'title:"确认操作"'],
    ['title:"Delete Scheduled Task?"', 'title:"删除定时任务？"'],
    ['children:"Cancel all runs"', 'children:"取消所有运行"'],
    ['title:"Cancel all runs"', 'title:"取消所有运行"'],
    ['children:"Loading context..."', 'children:"正在加载上下文..."'],
    ['children:"Loading chat..."', 'children:"正在加载对话..."'],
    ['label:"Copy JSON"', 'label:"复制 JSON"'],
    ['"Needs Attention"', '"需要关注"'],
    ['"Needs authentication"', '"需要身份验证"'],
    ['ariaLabel:"Loading suggestion",label:"Loading suggestion"', 'ariaLabel:"正在加载建议",label:"正在加载建议"'],
    ['label:"Download request content"', 'label:"下载请求内容"'],
    ['title:"Download request content"', 'title:"下载请求内容"'],
    ['children:"Failed to load diff"', 'children:"加载差异失败"'],
    ['e.message:"Failed to load diff"', 'e.message:"加载差异失败"'],
    ['children:"View setup instructions"', 'children:"查看设置说明"'],
    ['emptyMessage:"No changes"', 'emptyMessage:"暂无更改"'],
    ['?"No pending changes to review":"No changes to review"', '?"没有待审查的更改":"没有可审查的更改"'],
    ['"No changes to apply"', '"没有可应用的更改"'],
    ['"No changes to create PR"', '"没有更改，无法创建 PR"'],
    // ── 2026-08-08 未翻译清单：中频第二批（登录/云端/任务/对话框）──
    ['children:"Log in"', 'children:"登录"'],
    ['hintText:"Log in to use Cursor AI features"', 'hintText:"登录以使用 Cursor AI 功能"'],
    ['hintText:"Log in to use Cloud Agents"', 'hintText:"登录以使用云智能体"'],
    ['title:"Log In"', 'title:"登录"'],
    ['children:"Log In"', 'children:"登录"'],
    ['text:"Log In"', 'text:"登录"'],
    ['label:"New Chat"', 'label:"新对话"'],
    ['"New Chat"', '"新对话"'],
    ['children:"Cancel (esc)"', 'children:"取消 (esc)"'],
    ['children:"No (esc)"', 'children:"否 (esc)"'],
    ['children:"Run in Cloud"', 'children:"在云端运行"'],
    ['cloudOptionLabel:"Run in Cloud"', 'cloudOptionLabel:"在云端运行"'],
    ['label:"Run in Cloud"', 'label:"在云端运行"'],
    ['children:"Team Pool"', 'children:"团队资源池"'],
    ['label:"Team Pool"', 'label:"团队资源池"'],
    ['title:"My Machines"', 'title:"我的机器"'],
    ['children:"My Machines"', 'children:"我的机器"'],
    ['label:"My Machines"', 'label:"我的机器"'],
    ['label:"Create Cloud Automation"', 'label:"创建云自动化"'],
    ['children:"Create Cloud Automation"', 'children:"创建云自动化"'],
    ['label:"Delete Task"', 'label:"删除任务"'],
    ['children:"Delete Task"', 'children:"删除任务"'],
    ['label:"Replace Chat"', 'label:"替换对话"'],
    ['label:"Resize sidebar"', 'label:"调整侧边栏大小"'],
    ['"aria-label":"Resize sidebar"', '"aria-label":"调整侧边栏大小"'],
    ['title:"Import Chat"', 'title:"导入对话"'],
    ['label:"Import Claude Code Conversations"', 'label:"导入 Claude Code 对话"'],
    ['title:"Data Sharing"', 'title:"数据共享"'],
    ['children:"Side chats"', 'children:"侧边对话"'],
    ['"aria-label":"Side chats"', '"aria-label":"侧边对话"'],
    ['label:"Side chats"', 'label:"侧边对话"'],
    // ── 2026-08-08 未翻译清单：中频第三批 ──
    ['children:"Manage Usage"', 'children:"管理用量"'],
    ['children:"Move to folder"', 'children:"移动到文件夹"'],
    ['placeholder:"Search or enter URL"', 'placeholder:"搜索或输入 URL"'],
    ['children:"Invite by email"', 'children:"通过电子邮件邀请"'],
    ['"aria-label":"Close Window"', '"aria-label":"关闭窗口"'],
    ['children:"Close Window"', 'children:"关闭窗口"'],
    ['label:"Open Composer Settings",tooltip:"Open Composer Settings"', 'label:"打开 Composer 设置",tooltip:"打开 Composer 设置"'],
    ['title:{value:"Connect Slack",original:"Connect Slack"}', 'title:{value:"连接 Slack",original:"连接 Slack"}'],
    ['label:"Connect Slack"', 'label:"连接 Slack"'],
    ['title:"Clear History"', 'title:"清除历史记录"'],
    ['label:"Clear History"', 'label:"清除历史记录"'],
    ['label:"Got it"', 'label:"知道了"'],
    ['label:"Dismiss"', 'label:"忽略"'],
    ['"aria-label":"Dismiss"', '"aria-label":"忽略"'],
    ...
    ['"Explored"', '"已探索"'],
    ['"Waited"', '"已等待"'],
    ['completed:"Listed"', 'completed:"已列出"'],
    ['completed:"Grepped"', 'completed:"已搜索"'],
    ['loading:"Waiting"', 'loading:"正在等待"'],
    ...
    ['completed:"Read"', 'completed:"已读取"'],
    ['loading:"Writing"', 'loading:"正在写入"'],
    ['completed:"Wrote"', 'completed:"已写入"'],
    ['loading:"Searching"', 'loading:"正在搜索"'],
    ['completed:"Searched"', 'completed:"已搜索"'],
    ['loading:"Processing"', 'loading:"正在处理"'],
    ['completed:"Processed"', 'completed:"已处理"'],
    ['loading:"Executing"', 'loading:"正在执行"'],
    ['completed:"Executed"', 'completed:"已执行"'],
    ['loading:"Fetching"', 'loading:"正在获取"'],
    ['completed:"Fetched"', 'completed:"已获取"'],
    ['loading:"Editing"', 'loading:"正在编辑"'],
    ['completed:"Edited"', 'completed:"已编辑"'],
    ['loading:"Planning"', 'loading:"正在规划"'],
    ['completed:"Planned"', 'completed:"已规划"'],
    ['loading:"Reflecting"', 'loading:"正在反思"'],
    ['completed:"Reflected"', 'completed:"已反思"'],
    ['loading:"Updating todos"', 'loading:"正在更新待办"'],
    ['completed:"Updated todos"', 'completed:"已更新待办"'],
    ['loading:"Reading todos"', 'loading:"正在读取待办"'],
    ['completed:"Read todos"', 'completed:"已读取待办"'],
    ['loading:"Reading lints"', 'loading:"正在读取 Lints"'],
    ['completed:"Read lints"', 'completed:"已读取 Lints"'],
    ['loading:"Exploring tools"', 'loading:"正在探索工具"'],
    ['completed:"Explored tools"', 'completed:"已探索工具"'],
    ['loading:"Writing plan"', 'loading:"正在编写计划"'],
    ['completed:"Wrote plan"', 'completed:"已编写计划"'],
    ['loading:"Searching web"', 'loading:"正在搜索网页"'],
    ['completed:"Searched web"', 'completed:"已搜索网页"'],
    ['loading:"Working on task"', 'loading:"正在处理任务"'],
    ['completed:"Completed task"', 'completed:"已完成任务"'],
    ['loading:"Listing resources"', 'loading:"正在列出资源"'],
    ['completed:"Listed resources"', 'completed:"已列出资源"'],
    ['loading:"Reading resource"', 'loading:"正在读取资源"'],
    ['completed:"Read resource"', 'completed:"已读取资源"'],
    ['loading:"Applying diff"', 'loading:"正在应用差异"'],
    ['completed:"Applied diff"', 'completed:"已应用差异"'],
    ['loading:"Asking questions"', 'loading:"正在提问"'],
    ['completed:"Asked questions"', 'completed:"已提问"'],
    ['loading:"Looking up blame"', 'loading:"正在查看 Blame"'],
    ['completed:"Looked up blame"', 'completed:"已查看 Blame"'],
    ['loading:"Switching mode"', 'loading:"正在切换模式"'],
    ['completed:"Switched mode"', 'completed:"已切换模式"'],
    ['loading:"Generating image"', 'loading:"正在生成图片"'],
    ['completed:"Generated image"', 'completed:"已生成图片"'],
    ['loading:"Recording screen"', 'loading:"正在录制屏幕"'],
    ['completed:"Recorded screen"', 'completed:"已录制屏幕"'],
    ['loading:"Using computer"', 'loading:"正在使用电脑"'],
    ['completed:"Used computer"', 'completed:"已使用电脑"'],
    ['loading:"Writing to shell"', 'loading:"正在写入 Shell"'],
    ['completed:"Wrote to shell"', 'completed:"已写入 Shell"'],
    ['loading:"Setting up VM"', 'loading:"正在配置虚拟机"'],
    ['completed:"Set up VM"', 'completed:"已配置虚拟机"'],
    ['loading:"Replacing environment"', 'loading:"正在替换环境"'],
    ['completed:"Replaced environment"', 'completed:"已替换环境"'],
    ['loading:"Searching conversations"', 'loading:"正在搜索对话"'],
    ['completed:"Searched conversations"', 'completed:"已搜索对话"'],
    ['loading:"Creating goal"', 'loading:"正在创建目标"'],
    ['completed:"Created goal"', 'completed:"已创建目标"'],
    ['loading:"Updating goal"', 'loading:"正在更新目标"'],
    ['completed:"Updated goal"', 'completed:"已更新目标"'],
    ['loading:"Fetching page"', 'loading:"正在获取页面"'],
    ['completed:"Fetched page"', 'completed:"已获取页面"'],
    ['loading:"Reporting results"', 'loading:"正在报告结果"'],
    ['completed:"Reported results"', 'completed:"已报告结果"'],
    ['loading:"Learning from Cursor Blame"', 'loading:"正在从 Cursor Blame 学习"'],
    ['completed:"Learned from Cursor Blame"', 'completed:"已从 Cursor Blame 学习"'],
    ['loading:"Updating progress"', 'loading:"正在更新进度"'],
    ['completed:"Updated progress"', 'completed:"已更新进度"'],
    ['loading:"Managing PR"', 'loading:"正在管理 PR"'],
    ['completed:"Managed PR"', 'completed:"已管理 PR"'],
    ['loading:"Editing PR labels"', 'loading:"正在编辑 PR 标签"'],
    ['completed:"Edited PR labels"', 'completed:"已编辑 PR 标签"'],
    ['loading:"Fetching cloud agent data"', 'loading:"正在获取云智能体数据"'],
    ['completed:"Fetched cloud agent data"', 'completed:"已获取云智能体数据"'],
    ['loading:"Authenticating MCP server"', 'loading:"正在认证 MCP 服务器"'],
    ['completed:"Authenticated MCP server"', 'completed:"已认证 MCP 服务器"'],
    ['loading:"Connecting GitHub"', 'loading:"正在连接 GitHub"'],
    ['completed:"Connected GitHub"', 'completed:"已连接 GitHub"'],
    ['loading:"Reporting bug"', 'loading:"正在报告 Bug"'],
    ['completed:"Reported bug"', 'completed:"已报告 Bug"'],
    ['loading:"Recording final summary"', 'loading:"正在记录最终总结"'],
    ['completed:"Recorded final summary"', 'completed:"已记录最终总结"'],
    ['loading:"Sending message"', 'loading:"正在发送消息"'],
    ['completed:"Sent message"', 'completed:"已发送消息"'],
    ['loading:"Updating metadata"', 'loading:"正在更新元数据"'],
    ['completed:"Updated metadata"', 'completed:"已更新元数据"'],
    ['loading:"Updating code tour"', 'loading:"正在更新代码导览"'],
    ['completed:"Updated code tour"', 'completed:"已更新代码导览"'],
    ['loading:"Recording CI findings"', 'loading:"正在记录 CI 结果"'],
    ['completed:"Recorded CI findings"', 'completed:"已记录 CI 结果"'],
    // ── 用户反馈的未翻译词条：Glass/Agents 窗口专用 ──
...
const trickyReplacements = [
    ...
    {
        // Always Run 模板：`Always Run '${label}'` / `Always Run '${label}' + N`
        regex: /`Always Run '(\$\{[^}]+\})'(\s*\+\s*\$\{[^}]+\})?`/g,
        zh: '`始终运行 $1$2`'
    },
    {
...
['error:"Write"', 'error:"写入"'],
    ...
    ['placeholder:"Search"', 'placeholder:"搜索"'],
        ...
        ['buttonLabel:"Connect Your Repos"', 'buttonLabel:"连接你的仓库"'],
        ['"Unknown error"', '"未知错误"'],
        // ── 2026-08-08 未翻译清单：中频词条（desk 存在的形式）──
        ['children:"Fix All"', 'children:"全部修复"'],
        ['children:"Review Again"', 'children:"再次审查"'],
        ['hintText:"Review Again"', 'hintText:"再次审查"'],
        ['children:"Open settings"', 'children:"打开设置"'],
        ['children:"Install Now"', 'children:"立即安装"'],
        ['tooltip:"Delete chat"', 'tooltip:"删除对话"'],
        ['label:"Delete chat"', 'label:"删除对话"'],
        ...
        ['"Needs Attention"', '"需要关注"'],
        ['"Needs authentication"', '"需要身份验证"'],
        // ── 2026-08-08 未翻译清单：中频第二批（desk 存在的形式）──
        ['children:"Log in"', 'children:"登录"'],
        ['hintText:"Log in to use Cursor AI features"', 'hintText:"登录以使用 Cursor AI 功能"'],
        ['hintText:"Log in to use Cloud Agents"', 'hintText:"登录以使用云智能体"'],
        ['title:"Log In"', 'title:"登录"'],
        ...
        ['cloudOptionLabel:"Run in Cloud"', 'cloudOptionLabel:"在云端运行"'],
        ['label:"Replace Chat"', 'label:"替换对话"'],
        ['title:"Replace Chat"', 'title:"替换对话"'],
        ['title:"Import Chat"', 'title:"导入对话"'],
        ['label:"Import Claude Code Conversations"', 'label:"导入 Claude Code 对话"'],
        ['title:"Data Sharing"', 'title:"数据共享"'],
        ['title:"Remove local plugin"', 'title:"移除本地插件"'],
        // ── 2026-08-08 未翻译清单：中频第三批（desk 存在的形式）──
        ['children:"Manage Usage"', 'children:"管理用量"'],
        ['<div>Invite by email</div>', '<div>通过电子邮件邀请</div>'],
        ['label:"Open Composer Settings",tooltip:"Open Composer Settings"', 'label:"打开 Composer 设置",tooltip:"打开 Composer 设置"'],
        ['title:{value:"Connect Slack",original:"Connect Slack"}', 'title:{value:"连接 Slack",original:"连接 Slack"}'],
        ['label:"Connect Slack"', 'label:"连接 Slack"'],
        ['label:"Dismiss"', 'label:"忽略"'],
...
module.exports = { translate, restore, backupFile, restoreFromBackup, fixProductHash, getClpRoot };
